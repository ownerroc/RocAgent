 ...
 * Location: /sdcard/.agent/owner-lock/ (outside agent's workspace)
 */
const fs = require("fs");
const path = require("path");

const OWNER_LOCK_PATH = "/sdcard/.agent/owner-lock/owner-lock.json";
const AUDIT_LOG_PATH = "/sdcard/.agent/owner-lock/audit.log";
const KILL_SWITCH_PATH = "/sdcard/.agent/owner-lock/kill.switch";
